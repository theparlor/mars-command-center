/**
 * DRIVE Navigation Bar — Injected into all engagement HTML artifacts
...
(function() {
  ...
  let hubPath = 'Apex_DRIVE_Command_Center.html';
  let crumbs = [];

  // Build breadcrumbs based on directory depth
  if (path.includes('/schedule/')) {
    hubPath = '../Apex_DRIVE_Command_Center.html';
    crumbs = [
    ...
    hubPath = '../deliverables/Apex_DRIVE_Command_Center.html';
    crumbs = [
      { label: 'Command Center', href: hubPath },
  ...
  const pageTitle = document.title.replace('Apex DRIVE — ', '').replace('Apex DRIVE ', '');
