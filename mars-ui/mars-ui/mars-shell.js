/**
 * DRIVE Shell — Navigation drawer + Top bar for all engagement artifacts
 * Version: 0.2.0
 *
...
(function () {
  ...
  const SITE_MAP = [
    ...
    // ─── SOW LANE: Schedule & Timeline ───
    {
      ...
      items: [
        ...
        { label: 'Interactive Gantt', icon: '📊', href: 'schedule/Apex_DRIVE_Gantt_Views.html' },
    ...
    // ─── SOW LANE: Coaching Insights ───
    {
      ...
      anchor: 'coaching',
      items: [
        { label: 'Team Assessment Guide', icon: '🎤', href: 'Apex_DRIVE_Interview_Guide.html', primary: true },
        { label: 'Session Observation Guide', icon: '🔎', href: 'Apex_Roadmap_Session_Observation_Guide.html' },
    ...
    // ─── SOW LANE: OCM & Comms ───
    {
      ...
      anchor: 'ocm',
      items: [
        { label: 'Communication System', icon: '📡', href: 'Apex_Visual_Communication_System.html' },
      ]
    },
  ...
  function getCurrentSection() {
    ...
    return { section: '', anchor: '', page: document.title.replace('Apex DRIVE — ', '') };
  }
    ...
    document.body.innerHTML = `
      ...
      <div class="mars-topbar">
        <div class="mars-topbar-leading">
          ...
          ${current.section ? `
            <a href="${resolveHref('Apex_DRIVE_Command_Center.html')}${current.anchor ? '#' + current.anchor : ''}"
        ...
        <div class="mars-topbar-actions">
          <a href="${resolveHref('Apex_DRIVE_Command_Center.html')}"
