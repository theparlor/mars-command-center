/**
 * DRIVE Shell v0.3 — Navigation shell for all engagement artifacts
 *
 * Features:
...
(function () {
  ...
  const SITE_MAP = [
    {
      section: 'Home',
      items: [
        { label: 'Command Center', icon: '🏠', href: 'Apex_DRIVE_Command_Center.html' }
      ]
    },
    {
      ...
      anchor: 'schedule',
      items: [
        { label: 'Engagement Schedule', icon: '📋', href: 'schedule/Apex_DRIVE_Reconciled_Schedule.html', primary: true },
        { label: 'Gantt Chart', icon: '📊', href: 'schedule/Apex_DRIVE_Gantt_Views.html' },
        { label: 'Calendar View', icon: '🗓️', href: 'schedule/Apex_DRIVE_Calendar_View.html' },
    ...
    },
    {
      ...
      anchor: 'curriculum',
      items: [
        { label: 'Course Catalog', icon: '📖', href: 'curriculum/Apex_DRIVE_Course_Catalog.html', primary: true },
      ]
    },
    {
      ...
      anchor: 'coaching',
      items: [
        { label: 'Team Assessment', icon: '🎤', href: 'Apex_DRIVE_Interview_Guide.html', primary: true },
        { label: 'Session Observation', icon: '🔎', href: 'Apex_Roadmap_Session_Observation_Guide.html' },
    ...
    },
    {
      ...
      anchor: 'ocm',
      items: [
        { label: 'Visual Comms System', icon: '📡', href: 'Apex_Visual_Communication_System.html' },
        { label: 'Schedule Email', icon: '✉️', href: 'schedule/Apex_DRIVE_Schedule_Email.html' },
      ]
    },
    {
      ...
      anchor: 'organization',
      items: [
        { label: 'Org Chart', icon: '🏢', href: 'org/Apex_DRIVE_Org_Chart.html', primary: true },
        { label: 'Team Explorer', icon: '🔍', href: 'org/Apex_DRIVE_Team_Explorer.html' },
      ]
    },
    {
      ...
      anchor: 'status',
      items: [
        { label: 'Weekly Dashboard', icon: '📈', href: '../status_updates/Apex_DRIVE_Weekly_Status.html', primary: true },
      ]
    },
    {
  ...
  function getCurrentContext() {
    ...
    return {
      section: '',
      anchor: '',
      page: document.title.replace('Apex DRIVE — ', ''),
      siblings: [],
      isHome: false
    };
  }
  ...
  function buildNavHTML() {
    let html = `
      <div class="mars-nav-header">
        <h2>DRIVE</h2>
        <div class="nav-subtitle">Apex Agile Transformation</div>
      </div>
    `;
    ...
    html += `<div style="margin-top:auto;padding:16px;border-top:1px solid var(--outline-variant,#E5E7EB);font-size:10px;color:var(--text-muted,#9CA3AF);">
      DRIVE Command Center v0.3<br>Meridian Consulting
    </div>`;
    return html;
  }
  ...
  function buildBreadcrumb(ctx) {
    const homeHref = resolveHref('Apex_DRIVE_Command_Center.html');
    ...
    document.body.innerHTML = `
      <div class="mars-topbar" id="mars-topbar">
        ...
        <div class="mars-topbar-actions">
          <a href="${resolveHref('Apex_DRIVE_Command_Center.html')}" class="mars-home-btn">🏠 Home</a>
        </div>
      </div>
