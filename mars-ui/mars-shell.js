/**
 * DRIVE Shell v0.4 — Navigation shell for all engagement artifacts
 *
...
(function () {
  ...
  const SITE_MAP = [
    ...
    // ─── SOW LANE: Schedule & Planning ───
    {
      ...
      anchor: 'schedule',
      items: [
        { label: 'Engagement Schedule', icon: '📋', href: 'schedule/Apex_DRIVE_Reconciled_Schedule.html' },
    ...
    // Merged Curriculum + Coaching Insights (Vera: "one learning domain, not two")
    {
      ...
      anchor: 'training',
      items: [
        { label: 'Course Catalog', icon: '📖', href: 'curriculum/Apex_DRIVE_Course_Catalog.html' },
        { label: 'Team Assessment', icon: '🎤', href: 'Apex_DRIVE_Interview_Guide.html' },
    ...
    // Merged Organization + OCM (Vera: "both about people and how they work")
    {
      ...
      anchor: 'organization',
      items: [
        { label: 'Org Chart', icon: '🏢', href: 'org/Apex_DRIVE_Org_Chart.html' },
    ...
    // ─── Reference & Resources ───
    // Merged Frameworks + Brand + Meridian Team
  ...
  function buildNavHTML() {
    ...
    html += `<div style="margin-top:auto;padding:16px;border-top:1px solid var(--outline-variant,#E5E7EB);font-size:10px;color:var(--text-muted,#9CA3AF);">
      DRIVE Command Center v0.4<br>Meridian Consulting
    </div>`;
    return html;
  }
    ...
    document.body.innerHTML = `
      <div class="mars-topbar" id="mars-topbar">
        ...
        <div class="mars-topbar-actions">
          <a href="${resolveHref('Apex_DRIVE_Command_Center.html')}" class="mars-home-btn">🏠</a>
        </div>
      </div>
