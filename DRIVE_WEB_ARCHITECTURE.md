# DRIVE Web Architecture — Design Document

> Foundational reference for the DRIVE Command Center web application.
...
A web application that serves as the interactive command center for the Apex DRIVE Agile Transformation engagement. It provides a unified navigation experience across ~25 HTML artifacts — schedules, org charts, coaching tools, training catalogs, status dashboards, and design references.

### Who uses it?

- **Brien** — primary author, uses daily for engagement management
- **Meridian team peers** — Jason, Dean, Louise — view-only consumers of schedule, status, and coaching tools
- **Eventually: Apex stakeholders** — limited views embedded in SharePoint
...
```
deliverables/
├── Apex_DRIVE_Command_Center.html    # Hub page (archetype: hub)
├── Apex_DRIVE_Interview_Guide.html   # Coaching tool (archetype: detail)
├── Apex_Roadmap_Session_Observation_Guide.html
├── Leadership_Altitude_Model.html
├── SOW_Overview_Diagram.html
├── Apex_Visual_Communication_System.html
│
├── mars-ui/                           # ← THE UI KIT
...
│   ├── Apex_DRIVE_Reconciled_Schedule.html
│   ├── Apex_DRIVE_Gantt_Views.html
│   ├── Apex_DRIVE_Calendar_View.html
│   ├── Apex_DRIVE_Two_Week_Look_Ahead.html
│   ├── Apex_DRIVE_Card_View.html
│   ├── Apex_DRIVE_Decision_Log.html
│   └── Apex_DRIVE_Schedule_Email.html
│
├── org/                               # Organization
│   ├── Apex_DRIVE_Org_Chart.html
│   └── Apex_DRIVE_Team_Explorer.html
│
├── curriculum/                        # Curriculum & Training lane
│   └── Apex_DRIVE_Course_Catalog.html
│
...
status_updates/
└── Apex_DRIVE_Weekly_Status.html     # Dashboard (archetype: dashboard)
```
...
| **Meridian Team** | *(TBD)* | TBD | **NEW — not yet built** |
...
- **Command Center** always present as root, links to `Apex_DRIVE_Command_Center.html`
...
|------|-----------|---------|-----|
| `mars-command-center-internal` | Private | Real data, Apex names | github.com/theparlor/... |
...
| v0.2 | DRIVE UI Kit + Navigation shell added | 2026-03-18 |
...
|----|----------|-----------|------|
| AD-01 | **Custom DRIVE UI Kit** over Materialize/MDL/@material/web | No actively maintained Material CSS library fits our constraints (static HTML, no build, works in SharePoint). Custom kit gives us zero dependencies and full control. | 2026-03-18 |
...
| BD-03 | **Meridian Team section** added to navigation | Team needs an internal space for working materials, meeting notes, and Meridian-specific resources. | 2026-03-18 |
...
To spin up the DRIVE system for a new engagement (e.g., F&G proposal):
