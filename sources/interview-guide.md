...
# Apex DRIVE Team Behavior Assessment

## Purpose

The Apex DRIVE Interview Guide is a structured behavioral assessment tool designed to evaluate team health, agile maturity, and organizational alignment across six engineering teams at Apex of America. The guide uses 11 assessment categories and 49 behavioral questions to surface team practices, bottlenecks, decision patterns, and cultural health indicators.
...
- Visual feedback: selected option highlights with Apex blue border and light blue background
...
The interface uses the **mars-ui** design system (Apex's internal UI kit):

- **Header**: White background, Apex blue text, sticky top bar with progress counter
- **Team selector**: Rounded pill buttons, orange active state (lane-ocm)
- **Team info**: Apex blue text, manager and headcount metadata
